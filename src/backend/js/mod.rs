...
this.__ENV__["__op_bor__"] = this.__ENV__["(|)"];
this.__ENV__["__op_band__"] = this.__ENV__["(&)"];
this.__ENV__["__op_bxor__"] = this.__ENV__["(^)"];
this.__ENV__["__op_bsl__"] = this.__ENV__["(<<)"];
this.__ENV__["__op_bsr__"] = this.__ENV__["(>>)"];
this.__ENV__["__op_not__"] = this.__ENV__["(!)"];
this.__ENV__["__op_neg__"] = this.__ENV__["(neg)"];
this.__ENV__["__op_bnot__"] = this.__ENV__["(~)"];
